...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sistemas_proyecto` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;

USE `sistemas_proyecto`;
...
CREATE TABLE `t00100_usuario` (
  ...
  `Tx_Email` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `Uk_Usuario_Nb_Usuario` (`Nb_Usuario`),
...
/*Data for the table `t00100_usuario` */
...
/*Data for the table `t00290_producto_categoria` */
...
/*Data for the table `t00300_producto` */
...
CREATE TABLE `t99999_auditoria` (
  ...
  `Co_MAC` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
...
/*Data for the table `t99999_auditoria` */
...
CREATE TABLE `t99999_bitacora` (
  ...
  `Co_Bitacora_Previo` bigint(20) unsigned NOT NULL,
  `Co_Usuario` bigint(20) unsigned NOT NULL,
  `Fe_Ins` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
/*Data for the table `t99999_bitacora` */
